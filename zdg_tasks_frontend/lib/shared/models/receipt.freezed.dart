...
mixin _$Receipt {
 ...
 int get id; int get amount; bool get verified; DateTime? get verifiedAt; Attachment? get attachment;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amount,verified,verifiedAt,attachment);

@override
String toString() {
  return 'Receipt(id: $id, amount: $amount, verified: $verified, verifiedAt: $verifiedAt, attachment: $attachment)';
}
...
@useResult
$Res call({
 int id, int amount, bool verified, DateTime? verifiedAt, Attachment? attachment
});
...
/// Create a copy of Receipt
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? amount = null,Object? verified = null,Object? verifiedAt = freezed,Object? attachment = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int amount,  bool verified,  DateTime? verifiedAt,  Attachment? attachment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Receipt() when $default != null:
return $default(_that.id,_that.amount,_that.verified,_that.verifiedAt,_that.attachment);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int amount,  bool verified,  DateTime? verifiedAt,  Attachment? attachment)  $default,) {final _that = this;
switch (_that) {
case _Receipt():
return $default(_that.id,_that.amount,_that.verified,_that.verifiedAt,_that.attachment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int amount,  bool verified,  DateTime? verifiedAt,  Attachment? attachment)?  $default,) {final _that = this;
switch (_that) {
case _Receipt() when $default != null:
return $default(_that.id,_that.amount,_that.verified,_that.verifiedAt,_that.attachment);case _:
  return null;
...
class _Receipt implements Receipt {
  const _Receipt({required this.id, required this.amount, required this.verified, this.verifiedAt, this.attachment});
...
/// Create a copy of Receipt
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? amount = null,Object? verified = null,Object? verifiedAt = freezed,Object? attachment = freezed,}) {
