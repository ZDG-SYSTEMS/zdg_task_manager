...
mixin _$Attachment {
 ...
 int get id; AttachmentKind get kind; String get originalName; String get mimeType; int get size;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,kind,originalName,mimeType,size);

@override
String toString() {
  return 'Attachment(id: $id, kind: $kind, originalName: $originalName, mimeType: $mimeType, size: $size)';
}
...
@useResult
$Res call({
 int id, AttachmentKind kind, String originalName, String mimeType, int size
});
...
/// Create a copy of Attachment
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? kind = null,Object? originalName = null,Object? mimeType = null,Object? size = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,kind: null == kind ? _self.kind : kind // ignore: cast_nullable_to_non_nullable
as AttachmentKind,originalName: null == originalName ? _self.originalName : originalName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  AttachmentKind kind,  String originalName,  String mimeType,  int size)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Attachment() when $default != null:
return $default(_that.id,_that.kind,_that.originalName,_that.mimeType,_that.size);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  AttachmentKind kind,  String originalName,  String mimeType,  int size)  $default,) {final _that = this;
switch (_that) {
case _Attachment():
return $default(_that.id,_that.kind,_that.originalName,_that.mimeType,_that.size);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  AttachmentKind kind,  String originalName,  String mimeType,  int size)?  $default,) {final _that = this;
switch (_that) {
case _Attachment() when $default != null:
return $default(_that.id,_that.kind,_that.originalName,_that.mimeType,_that.size);case _:
  return null;
...
class _Attachment implements Attachment {
  const _Attachment({required this.id, required this.kind, required this.originalName, required this.mimeType, required this.size});
...
/// Create a copy of Attachment
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? kind = null,Object? originalName = null,Object? mimeType = null,Object? size = null,}) {
